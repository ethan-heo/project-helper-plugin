...
| --- | --- | --- | --- |
| 6.0 | 2026-09-24 00:35 | README.md, decisions.md, documentation-validation.md, learning-flow.md, learning-workspace.md | 실습 계약·시작 자료·초기 검증·계획 초안 계약 추가 |
