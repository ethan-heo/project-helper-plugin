...
| 진단 결과 | 독립 설명·부분 이해·재학습 필요의 세 구분 |
| 복습 시점 | 완료 뒤 1·3·7·14일과 필요한 보충 시점 |
...
| --- | --- | --- | --- |
| 6.1 | 2026-09-24 00:45 | README.md, decisions.md, documentation-validation.md, learning-workspace.md | 실습 계약 용어를 과제 요구사항으로 변경 |
| 6.0 | 2026-09-24 00:35 | README.md, decisions.md, documentation-validation.md, learning-flow.md, learning-workspace.md | 과제 요구사항·시작 자료·초기 검증·계획 초안 계약 추가 |
| 5.6 | 2026-09-23 15:40 | README.md, decisions.md, learning-flow.md | 같은 날의 기본·보충 복습 병합 규칙 추가 |
