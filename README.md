...
Claude Code와 Codex에서 함께 쓰는 플러그인 마켓플레이스입니다. 지금은 `project-helper` 하나를 담고 있습니다. 제품의 목적과 요구사항을 정하고, 여러 계획이 따를 공용 구조를 아키텍처 문서로 남깁니다. 그 결정을 따라 구현 계획을 세우고 실행하며, 커밋 이력은 학습 문서로 정리합니다.
